...
<script type="application/javascript">
            ...
            onExpandRow:function(index,row,$detail){
                ...
                $(cur_table).bootstrapTable({
                    ...
                    columns:[
                        ...
                        {field:'goodsVolume',title:'核算体积(立方米)'},
    ...
    */
    ...
    function operationFormatter(value,row,index){
        ...
        html +='<a title="核对信息" href="javascript:;" onclick="order_check('+row.orderId+')" style="text-decoration:none;color:cornflowerblue"><span class="glyphicon glyphicon-check"></span></a>&nbsp;&nbsp;&nbsp;';
        ...
        layer.open(
            {
                ...
                shade:[0],
                area:['100%','100%'],
                content:["order/checkEdit.do?orderId="+id,'yes'] //iframe的url，no代表不显示滚动条
