...
<article class="page-container">
	...
	<input type="hidden" name="orderId" value="${order.orderId}">
		...
		<div class="col-xs-4 col-sm-4">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<select name="freightMethodId" id="freightMethod">
		...
		<div class="row cl">
			<div class="col-xs-4 col-sm-4">
				...
				<div class="formControls col-xs-8 col-sm-6">
					<input type="text" class="input-text" value="${order.takeMoney}" required="required"  placeholder="请输入取件费用（元）" id="takeMoney" name="takeMoney">
				</div>
			</div>
			<div class="col-xs-4 col-sm-4">
				<label class="form-label col-xs-4 col-sm-6">体积费率（元/方）：</label>
				<div class="formControls col-xs-8 col-sm-6">
					<input type="text" class="input-text" value="${order.volumeRate}" required="required"   placeholder="请输入体积费率（元/方）" id="volumeRate" name="volumeRate">
				</div>
			</div>
			<div class="col-xs-4 col-sm-4">
				<label class="form-label col-xs-4 col-sm-6">重量费率（元/千克）：</label>
				<div class="formControls col-xs-8 col-sm-6">
					<input type="text" class="input-text" value="${order.weightRate}" required="required"  placeholder="请输入重量费率（元/千克）" id="weightRate" name="weightRate">
				</div>
			</div>
		</div>
	...
	<div  id="order_detail" class="row cl">
		<div>
			...
			<div  class="col-xs-2 col-sm-2 order_detail">体积（立方米）</div>
			<div  class="col-xs-2 col-sm-2 order_detail">重量（kg）</div>
		...
		<c:forEach items="${order.orderDetails}" var="orderDetail">
			<div id="goods_detail">
				...
				<div  class="col-xs-2 col-sm-1 order_detail">
					<input type="text" size="3"  onkeyup="operationVolume(this);" name="orderDetails[][goodsNumber]" value="${orderDetail.goodsNumber}">
				</div>
				<div  class="col-xs-2 col-sm-1 order_detail">
					<select name="orderDetails[][goodsUnit]">
						<c:forEach items="${units}" var="unitEach">
				...
				<div  class="col-xs-2 col-sm-1 order_detail">
					<input type="text"  size="3"  onkeyup="operationVolume(this);"  name="orderDetails[][goodsLength]" value="${orderDetail.goodsLength}">

				</div>
				<div  class="col-xs-2 col-sm-1 order_detail">
					<input type="text"  size="3" onkeyup="operationVolume(this);" name="orderDetails[][goodsWidth]" value="${orderDetail.goodsWidth}">
				</div>
				<div  class="col-xs-2 col-sm-1 order_detail">
					<input type="text" size="3" onkeyup="operationVolume(this);" name="orderDetails[][goodsHeight]" value="${orderDetail.goodsHeight}">
				</div>
				<div  class="col-xs-2 col-sm-2 order_detail">
					<input type="text" name="orderDetails[][goodsVolume]" value="${orderDetail.goodsVolume}">
				</div>
				<div  class="col-xs-2 col-sm-2 order_detail">
					<input type="text" name="orderDetails[][goodsWeight]" value="${order.freightMethodId eq 10 ? orderDetail.goodsWeight:0}"    >
				</div>
				<div  class="col-xs-2 col-sm-1 order_detail order_add">
				<span style="cursor: pointer;color: red"
					  class="glyphicon glyphicon-remove"
...
function operationVolume(obj){
	...
	if(numberValue !="" && lengthValue !=""&& widthValue !=""&& heightValue !=""){
		//计算并设置总价的值
		inputs[6].value = numberValue * lengthValue * widthValue * heightValue / 1000000;
	}
}
