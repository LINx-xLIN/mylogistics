...
<div class="pd-20">
    ...
    <span class="l">
        <shiro:hasPermission name="admin:batchDelete">
        ...
        <shiro:hasPermission name="admin:insert">
         <a href="javascript:;" onclick="admin_add()" class="btn btn-primary radius"><i class="icon-plus"></i> 添加用户</a>
        </shiro:hasPermission>
    </span>
...
<script type="application/javascript">
    ...
    */
    function operationFormatter(value,row,index){
        ...
        var html = '<shrio:hasPermission name="admin:update">';

        html +='<a title="编辑" href="javascript:;" onclick="admin_edit('+row.userId+')" style="text-decoration:none;color: #00B83F"><i class="Hui-iconfont"></i></a>&nbsp;&nbsp;&nbsp;';

        html += '</shrio:hasPermission>';

        html += '<shrio:hasPermission name="admin:delete">';

        html += '<a title="删除" href="javascript:;" onclick="admin_del('+row.userId+')" class="ml-5" style="text-decoration:none;color: red"><i class="Hui-iconfont"></i></a>';
...
<script type="application/javascript">
    ...
    function batch_del() {
        ...
        layer.confirm('确认要删除吗？',function (index) {
            var ids = $('#userTable').bootstrapTable('getAllSelections');
            var userIds = new Array();
            for (var i=0;i<ids.length;i++){
                userIds.push(ids[i].userId);
            }

            $.post("admin/batchDelete.do",{userIds:userIds},function (data) {
    ...
    function admin_edit(id) {
        layer_show("修改管理员","admin/edit.do?userId="+id,800,500);
